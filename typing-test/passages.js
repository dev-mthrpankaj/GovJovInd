(function () {
  ...
  const sscCglDestPassage1 = [
    ...
    "Technology has made modern life easier in many ways. Students can access educational material online, communicate with teachers, attempt mock tests, and learn new skills without leaving their homes. At the same time, technology can become a major source of distraction. A person may open a mobile phone to check one important message and suddenly realize that thirty minutes have been spent watching short videos or browsing social media. Therefore, learning to control digital distractions has become an important part of personal discipline.",
    "One useful method is to divide a large goal into smaller tasks. A goal such as preparing for an examination can appear difficult because it includes many subjects, chapters, practice tests, and revisions. Instead of thinking about the entire syllabus at once, a student can decide what needs to be completed today. Finishing a small task creates a sense of progress and makes the next task easier to begin. Over several weeks, these small achievements can produce a significant improvement.",
    "Mistakes are also a natural part of learning. Many people become disappointed when they make errors, but errors provide valuable information. During typing practice, for example, speed is important, but accuracy is equally important. Typing quickly while making frequent mistakes may reduce the final performance. A learner should first develop control and accuracy and then gradually increase speed. With regular practice, the fingers begin to remember the position of the keys, and typing becomes more natural.",
    "The same principle applies to almost every skill. A person learning mathematics becomes faster by solving questions regularly. A runner improves endurance through repeated training. A writer develops better communication skills by reading and writing frequently. Improvement may not always be visible from one day to the next, but consistent effort produces noticeable results over time. This is why comparing today's performance with yesterday's performance can be more useful than constantly comparing yourself with other people.",
    "Patience is another important quality. Modern society often encourages people to expect immediate results, but meaningful achievements usually require time. A new skill may take months to develop, and a major career goal may require years of preparation. There will be days when progress seems slow. During such periods, it is important to remember why the journey was started. A temporary difficulty should not become a permanent reason to quit.",
    "A positive environment can also improve productivity. A clean study table, proper lighting, comfortable seating, and limited distractions can make concentration easier. Before beginning an important task, keeping unnecessary notifications turned off can help maintain focus. Some people also find it useful to prepare a short list of tasks for the day. The list should remain realistic because an extremely long list can create unnecessary pressure. Completing three important tasks properly is often better than starting ten tasks and finishing none of them.",
    "Physical health should not be ignored while pursuing academic or professional goals. Proper sleep, regular physical activity, sufficient water, and nutritious food help the body and mind perform efficiently. Working continuously without adequate rest can reduce concentration and increase the chances of mistakes. A short break after a focused work session can refresh the mind and make the next session more productive.",
    "Confidence develops through preparation. People sometimes believe that confident individuals are naturally fearless, but confidence is often created by repeated practice. A student who has completed several mock tests knows what to expect in the examination. A speaker who has practised a presentation several times feels more comfortable in front of an audience. Similarly, a person who practises typing regularly becomes less concerned about finding individual keys and can focus more on the content being typed.",
    "It is also important to measure progress correctly. Suppose a person's typing speed is thirty words per minute today. Instead of immediately targeting seventy words per minute, the learner can first aim for thirty-five words per minute while maintaining high accuracy. Once that level becomes comfortable, the target can be increased gradually. Small and measurable improvements make a large goal feel achievable.",
    "Competition can provide motivation, but personal progress should remain the main focus. Different people begin from different positions and have different responsibilities, opportunities, and experiences. Someone may learn a skill quickly, while another person may need additional practice. What matters is whether the individual continues to improve. Consistency eventually creates an advantage because many people stop practising when immediate results do not appear.",
    "Failure should also be understood correctly. Failing an examination, losing a competition, or making a poor decision does not automatically mean that all previous effort was wasted. The experience can reveal weaknesses that were previously unnoticed. A thoughtful person reviews the result, identifies what went wrong, changes the strategy, and tries again with better preparation. In this way, failure becomes feedback rather than the end of the journey.",
    "The ability to remain calm under pressure is especially valuable during examinations and typing tests. When people become nervous, they often rush and make avoidable mistakes. Maintaining a steady rhythm is usually more effective than trying to type at maximum speed from the first second. If an error occurs, correct it according to the rules of the test and continue instead of thinking about the mistake for too long. One error should not affect the next several lines.",
    "Daily habits ultimately shape long-term results. Reading a few pages every day, practising typing for fifteen minutes, solving a small set of questions, exercising regularly, or learning one new concept may appear insignificant when viewed separately. However, repeated over hundreds of days, these activities can completely change a person's knowledge and abilities. The power of consistency comes from accumulation.",
    "There is no perfect time to begin improving. Waiting for the ideal situation often becomes another form of delay. A person does not need perfect equipment, unlimited free time, or complete confidence to start. The first step can be small. Once the action becomes a habit, maintaining it becomes easier. Progress creates motivation, and motivation encourages further progress.",
    "In the end, success is not only about talent or intelligence. It is also about showing up regularly, working with patience, learning from mistakes, and continuing when progress is slow. Discipline provides direction, consistency creates improvement, and patience allows enough time for effort to produce results. A person who develops these qualities can face challenges with greater confidence and move steadily toward personal, academic, and professional goals. The journey may not always be easy, but every focused effort contributes to the final result. The most important thing is to begin, practise regularly, measure improvement, and keep moving forward."
  ].join(" ");
