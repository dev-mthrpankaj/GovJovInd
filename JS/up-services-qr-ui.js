(function(){
  ...
  function patch(){
    ...
    if(card && card.dataset.qrReady !== "1"){
      ...
      card.innerHTML = '<span class="payment-step-badge">Step 1: Pay first</span><h2><i class="fas fa-qrcode"></i> Scan & Pay ₹80</h2><div class="payment-upi-card payment-qr-card"><p><strong>Hindi:</strong> Form submit karne se pehle QR code scan karke ₹80 payment karein. Payment ke baad UTR / Transaction ID form me enter karna zaroori hai.</p><p><strong>English:</strong> Please scan the QR code and pay ₹80 before submitting the form. After payment, enter the UTR / Transaction ID in the form.</p><div class="payment-qr-wrap"><img id="paymentQrImage" src="'+QR_PATH+'" alt="Scan QR to pay ₹80" loading="lazy" decoding="async"></div><div class="payment-qr-meta"><div class="payment-qr-fee"><span>Amount</span><strong>₹80</strong></div><div class="payment-qr-fee"><span>Purpose</span><strong>UP Certificate Service</strong></div></div><p class="cert-note payment-bilingual-note"><span class="note-line"><span class="note-lang">Hindi:</span>Pehle payment karein, phir neeche form me Payment UTR / Transaction ID aur payment screenshot submit karein.</span><span class="note-line"><span class="note-lang">English:</span>First complete the payment, then submit the Payment UTR / Transaction ID and payment screenshot in the form below.</span></p></div>';
    }
