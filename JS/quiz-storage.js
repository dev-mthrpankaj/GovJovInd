    ...
    function initQuizMobileHeaderFix() {
        ...
        style.textContent = `
            @media (max-width: 767px) {
                ...
                body.quiz-attempt-route.gju-quiz-exam-mode .exam-main { display: grid !important; grid-template-rows: 46px minmax(0, 1fr) 86px !important; gap: 5px !important; padding: 0 !important; }
                ...
                body.quiz-attempt-route.gju-quiz-exam-mode .exam-actions { position: relative !important; left: auto !important; right: auto !important; bottom: auto !important; z-index: 40 !important; grid-template-columns: minmax(62px, .55fr) minmax(108px, .95fr) minmax(0, 1.35fr) !important; gap: 8px !important; padding: 8px 8px max(24px, env(safe-area-inset-bottom)) !important; background: var(--qa-surface, #ffffff) !important; border-top-color: var(--qa-border, #dce5f0) !important; }
