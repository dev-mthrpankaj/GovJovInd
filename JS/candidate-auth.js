(function () {
    ...
    function initCandidateMobileHeaderFix() {
        if (document.getElementById('gjuCandidateMobileHeaderFix')) return;
        const style = document.createElement('style');
        style.id = 'gjuCandidateMobileHeaderFix';
        style.textContent = `
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCandidateMobileHeaderFix);
    } else {
        initCandidateMobileHeaderFix();
    }
