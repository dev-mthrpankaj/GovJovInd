(function () {
    ...
    registerSubjectQuizzes([
        ...
        quizMeta("ssc-cgl-tier-1-12-sep-2025-shift-2-quant", "Mathematics", "SSC CGL Tier 1 - 12 Sep 2025 Shift 2 Quant (Bilingual)",
        quizMeta("ssc-cgl-quant-pyq-2025-set-3", "Mathematics", "SSC CGL Tier 1 - 12 Sep 2025 Shift 3 Quant (Bilingual)", "Hindi-English bilingual SSC CGL Tier 1 quantitative aptitude questions from 12 Sep 2025 Shift 3.", "Previous Year", "quiz-data/mathematics/ssc-cgl-tier-1-12-sep-2025-shift-2-quant.js") "Hindi-English bilingual SSC CGL Tier 1 quantitative aptitude questions from 12 Sep 2025 Shift 3.", "Previous Year", "quiz-data/mathematics/ssc-cgl-quant-pyq-2025-set-3.js"),
    ]);
}());
