    ...
    resultListings.innerHTML = results.map((result, index) => `
        <div class="result-card">
            ...
            <div class="result-actions">
                ${result.resultLink && result.resultLink !== "#" ? `<a href="${result.resultLink}" target="_blank" rel="noopener" class="btn btn-primary">View Result</a>` : `<button class="btn btn-primary" disabled>Link Unavailable</button>`}
