(function () {
  ...
  const createCard = (article) => {
    ...
    content.innerHTML = `
      ...
      <a class="section-link" href="${article.url ? `HTML/student-hub/${article.url.split('/').pop()}` : 'HTML/student-hub.html'}">Read: ${article.title || 'Student Hub article'} <i class="fas fa-arrow-right" aria-hidden="true"></i></a>
    `;
